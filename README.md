...
This plugin is highly customizable, you can change background, text and button colors without modifying the CSS, to better fit to your website color palette. It also comes optimized for mobile devices.
