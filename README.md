...
This plugin is highly customizable, you can change background, text and button colors without modifying the CSS, and addapt it better on your website color palette. It also comes preoptimized for mobile devices.
